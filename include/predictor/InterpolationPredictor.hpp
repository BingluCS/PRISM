...
void spline_construct(StatBuffer<T>* input, Buffer* anchor, Buffer* ectrl, void* ectrl_tmp, olBuffer<T>* outlier, 
    double eb, double rel_eb, uint32_t radius, interpolation_parameters& intp_param, Buffer* profiling_errors, double& time, void* stream);
